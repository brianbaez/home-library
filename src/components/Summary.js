      ...
      <div className="container mt-5">
        ...
        <div className="d-flex flex-column-reverse flex-lg-row">
          <div className="mt-4 mt-lg-0">
            ...
            <p className="fs-5 mt-4">Create <strong>book lists</strong> you can share with family and friends.</p>
          </div>
        ...
        <div className="d-flex flex-column-reverse flex-lg-row-reverse mt-5">
          <div className="mt-4 mt-lg-0">
            ...
            <p className="fs-5 mt-4">We'll show you <strong>charts and graphs</strong> that are fun to see.</p>
          </div>
